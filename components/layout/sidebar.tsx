  ...
  return (
    <>
      ...
      <Button
        variant="ghost"
        size="icon"
        className="hidden md:flex fixed top-4 left-4 z-50 bg-slate-800 text-white hover:bg-slate-700 transition-all duration-300"
        style={{ 
      ...
      {/* Sidebar */}
      <div className={cn(
        "fixed inset-y-0 left-0 z-40 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white transform transition-all duration-300 ease-in-out shadow-2xl",
        // Mobile styles
        "md:translate-x-0",
        ...
        <div className="absolute bottom-16 left-0 right-0 px-2">
          <Button
            variant="ghost"
            className={cn(
              "w-full flex items-center px-3 py-3 text-sm font-medium rounded-lg transition-all duration-200 text-red-300 hover:bg-red-900 hover:text-red-100",
